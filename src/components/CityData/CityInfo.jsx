...
class CityInfo extends Component {
  ...
  render() {
    const { cityName, cityData, isOpen, currencySymbol } = this.state;
    ...
    if (cityData !== null) {
      ...
      const checkSupermarket =
        costOfApples + costOfEggs + costOfChicken + costOfBeer + costOfMilk;
        ...
        <Container>
          ...
          {yearAvgTemp && (
            <Typography variant="h6" sx={{ my: "8px" }}>
              ...
              {new Intl.NumberFormat("es-418").format(yearAvgTemp)} ºC
            </Typography>
          )}
          <IconButton
            onClick={this.toggle}
                ...
                <Grid item xs={12} md={6} lg={6}>
                  {checkPrices !== 0 && (
                    <Container>
                      ...
                      <Typography variant="caption" sx={{ my: "2px" }}>
                        Costs are calculated in euros
                      </Typography>
                      <Typography variant="body1" sx={{ my: "4px" }}>
                        {apartmentCost &&
                          apartmentCost !== "0" &&
                          "Water, electricity and waste tax: " +
                            apartmentCost +
                            " " +
                            currencySymbol}
                      </Typography>
                      <Typography variant="body1" sx={{ my: "4px" }}>
                        {internetCost &&
                          internetCost !== "0" &&
                          "Wifi fee: " + internetCost + " " + currencySymbol}
                      </Typography>
                      <Typography variant="body1" sx={{ my: "4px" }}>
                        {salaryAvg &&
                          salaryAvg !== "0" &&
                  ...
                  {checkSupermarket !== 0 && (
                    <Container>
                      ...
                      <Typography variant="body1" sx={{ my: "4px" }}>
                        {costOfMilk &&
                          costOfMilk !== "0" &&
                          "1/2 L of milk: " + costOfMilk + " " + currencySymbol}
                      </Typography>
                    </Container>
                  )}
                </Grid>
                  ...
                  <Container>
                    ...
                    {histAvgTempIds.map((number) => (
                      ...
                      >
                        ...
                        {new Intl.NumberFormat("es-418").format(
                          histAvgTemp[number.value],
                        ) + "ºC "}
