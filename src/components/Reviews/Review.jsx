...
const review = ({ data }) => {
  ...
  const avgRating = (Number(data.weather) + Number(data.food) + Number(data.social) + Number(data.trips)) / 4;
      ...
      <Container style={{ padding: 2 }}>
        <Grid container spacing={2}>
          <Grid item xs={12} style={{ padding: 7 }}>
            ...
            <span style={{ paddingLeft: "10px", fontWeight: "bold" }}>Average:</span>
            ...
            <Grid container spacing={2} justifyContent="center" style={{padding: 10}}>
              ...
              <Grid item lg={3} md={3} sm={6} xs={6}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <ModeOfTravelIcon style={{ marginLeft: '8px', marginRight: '8px' }}/>
                  <Typography display="inline" >
