...
import HousemateForm from 'components/Forms/HousemateForm'


const HousematePage = ({dispatch, selectedCity, citiesIndex}) => {
...
export default connect(mapStateToProps)(withAuth(HousematePage))
